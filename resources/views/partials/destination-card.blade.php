...
<article class="glass-strong flex flex-col overflow-hidden rounded-[28px] transition-transform duration-300 hover:-translate-y-2">
    <div class="relative h-[210px] bg-[#dfe5de] bg-cover bg-center" style="background-image:url('{{ $destination->heroImageUrl(1000, 700) }}')">
    ...
    <div class="flex flex-1 flex-col p-6">
        ...
        {{-- Its own packages, or an enquiry about it when none are linked yet. --}}
        <a href="{{ $destination->packagesUrl() }}" class="btn btn-primary self-start px-4.5 py-3 text-[12.5px]">
            {{ $destination->publishedPackageCount() ? __('site.destinations.see_packages') : __('site.nav.enquire_now') }}
        </a>
    </div>
</article>
